...
>
  <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 lg:gap-12 text-center lg:text-left">
    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 font-display max-w-[600px] w-full">
      Bu ishni amalga oshirayotgan{" "}
      <span className="text-[#E11D48]">iste’dodli jamoamiz</span> bilan tanishing
    </h2>

    <p className="  sm:text-end text-center sm:text-lg md:text-xl lg:text-2xl text-gray-600 max-w-[600px] w-full">
      Tajribali mutaxassislarimiz siz uchun bir jamoa bo‘lib ishlaydi — har bir loyiha biz uchun
      mas’uliyat va ilhom manbai.
    </p>
  </div>
</motion.div>
